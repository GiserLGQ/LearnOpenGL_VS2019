...
int main()
{
    ...
    Shader myshader("ShaderPath/more_3D/shader.vs", "ShaderPath/more_3D/shader.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        */
        ...
        projection = glm::perspective(glm::radians(45.0f), 10.0f+(float)SCR_WIDTH / (float)SCR_HEIGHT, 0.1f, 100.0f);
