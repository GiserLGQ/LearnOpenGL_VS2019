...
int main()
{
 ...
 /*   glPolygonMode(GL_FRONT_AND_BACK, GL_LINE);*/
    ...
    Shader objShader("ShaderPath/lighting_specular_shader/obj.vs", "ShaderPath/lighting_specular_shader/obj.fs");
    Shader lightshader("ShaderPath/lighting_specular_shader/light.vs", "ShaderPath/lighting_specular_shader/light.fs");
