...
int main()
{
 ...
 /*   glPolygonMode(GL_FRONT_AND_BACK, GL_LINE);*/
    ...
    Shader objShader("ShaderPath/practice2/obj.vs", "ShaderPath/practice2/obj.fs");
    Shader lightshader("ShaderPath/practice2/light.vs", "ShaderPath/practice2/light.fs");
