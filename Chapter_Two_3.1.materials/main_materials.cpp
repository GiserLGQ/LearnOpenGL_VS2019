...
int main()
{
 ...
 /*   glPolygonMode(GL_FRONT_AND_BACK, GL_LINE);*/
    ...
    objShader.use();
    objShader.setVec3("material.ambient", glm::vec3(0.24725f, 0.1995f, 0.0745f));
    objShader.setVec3("material.diffuse", glm::vec3(0.75164f, 0.60648f, 0.22648f));
    objShader.setVec3("material.specular", glm::vec3(0.628281f, 0.555802f, 0.366065f));
