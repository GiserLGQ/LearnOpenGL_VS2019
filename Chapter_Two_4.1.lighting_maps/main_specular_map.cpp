...
int main()
{
 ...
 /*   glPolygonMode(GL_FRONT_AND_BACK, GL_LINE);*/
    ...
    Shader objShader("ShaderPath/main_specular_map/obj.vs", "ShaderPath/main_specular_map/obj.fs");
    Shader lightshader("ShaderPath/main_specular_map/light.vs", "ShaderPath/main_specular_map/light.fs");
