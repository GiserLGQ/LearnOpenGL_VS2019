...
int main()
{
 ...
 /*   glPolygonMode(GL_FRONT_AND_BACK, GL_LINE);*/
    ...
    Shader objShader("ShaderPath/practice3/obj.vs", "ShaderPath/practice3/obj.fs");
    Shader lightshader("ShaderPath/practice3/light.vs", "ShaderPath/practice3/light.fs");
    ...
    objShader.setInt("material.diffuse", 0); // 或者使用着色器类设置
        ...
        //生成纹理对象
    unsigned int specularMap = loadTexture("textures/container2_specular_colored.png");
    //设置每个采样器的方式告诉OpenGL每个着色器采样器属于哪个纹理单元。我们只需要设置一次即可
      //将要用的纹理单元赋值到material.diffuse这个uniform采样器，并绑定箱子的纹理到这个纹理单元：
