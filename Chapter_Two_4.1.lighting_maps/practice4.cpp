...
int main()
{
 ...
 /*   glPolygonMode(GL_FRONT_AND_BACK, GL_LINE);*/
    ...
    Shader objShader("ShaderPath/practice4/obj.vs", "ShaderPath/practice4/obj.fs");
    Shader lightshader("ShaderPath/practice4/light.vs", "ShaderPath/practice4/light.fs");
    ...
    objShader.setVec3("light.diffuse", glm::vec3(0.5f, 0.5f, 0.5 )); // 将光照调暗了一些以搭配场景
    ...
    //设置每个采样器的方式告诉OpenGL每个着色器采样器属于哪个纹理单元。我们只需要设置一次即可
      //将要用的纹理单元赋值到material.diffuse这个uniform采样器，并绑定箱子的纹理到这个纹理单元：
    objShader.setInt("material.emission", 2); // 或者使用着色器类设置
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        */
        ...
        objShader.setFloat("matrixmove", glfwGetTime());
