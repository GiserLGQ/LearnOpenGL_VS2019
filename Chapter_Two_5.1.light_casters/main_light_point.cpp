...
int main()
{
 ...
 /*   glPolygonMode(GL_FRONT_AND_BACK, GL_LINE);*/
    ...
    Shader objShader("ShaderPath/main_light_point/obj.vs", "ShaderPath/main_light_point/obj.fs");
    Shader lightshader("ShaderPath/main_light_point/light.vs", "ShaderPath/main_light_point/light.fs");
