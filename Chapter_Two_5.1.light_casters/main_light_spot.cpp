...
int main()
{
 ...
 /*   glPolygonMode(GL_FRONT_AND_BACK, GL_LINE);*/
    ...
    Shader objShader("ShaderPath/main_light_spot/obj.vs", "ShaderPath/main_light_spot/obj.fs");
    Shader lightshader("ShaderPath/main_light_spot/light.vs", "ShaderPath/main_light_spot/light.fs");
