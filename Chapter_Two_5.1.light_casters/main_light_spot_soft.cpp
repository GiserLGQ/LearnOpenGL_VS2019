...
int main()
{
 ...
 /*   glPolygonMode(GL_FRONT_AND_BACK, GL_LINE);*/
    ...
    Shader objShader("ShaderPath/main_light_spot_soft/obj.vs", "ShaderPath/main_light_spot_soft/obj.fs");
    Shader lightshader("ShaderPath/main_light_spot_soft/light.vs", "ShaderPath/main_light_spot_soft/light.fs");
    ...
    objShader.setVec3("light.diffuse", glm::vec3(1.0f, 1.0f, 1.0f)); // 将光照调暗了一些以搭配场景
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        */
        ...
        //传入顶点着色器
        //objShader.setVec3("light.direction", glm::vec3(0.f, 0.f, -1.0f));
        ...
        objShader.setFloat("light.outerCutOff", glm::cos(glm::radians(30.f)));
