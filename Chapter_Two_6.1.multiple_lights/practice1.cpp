...
int main()
{
 ...
 /*   glPolygonMode(GL_FRONT_AND_BACK, GL_LINE);*/
    ...
    Shader objShader("ShaderPath/practice1/obj.vs", "ShaderPath/practice1/obj.fs");
    Shader lightshader("ShaderPath/practice1/light.vs", "ShaderPath/practice1/light.fs");
    Shader wallshader("ShaderPath/practice1/wall.vs", "ShaderPath/practice1/wall.fs");
    ...
    wallshader.use();
    unsigned int wallMap = loadTexture("textures/brickwall.jpg");
    wallshader.setInt("material.diffuse", 3); // 或者使用着色器类设置
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        */
        ...
        objShader.setVec3("dirLight.diffuse", 0.8f, 0.8f, 0.8f);
        objShader.setVec3("dirLight.specular", 0.5f, 0.5f, 0.5f);
        // 点光源1
        objShader.setVec3("pointLights.position", pointLightPositions);
        objShader.setVec3("pointLights.ambient", 0.05f, 0.05f, 0.05f);
        objShader.setVec3("pointLights.diffuse", 0.8f, 0.8f, 0.8f);
        objShader.setVec3("pointLights.specular", 1.0f, 1.0f, 1.0f);
        objShader.setFloat("pointLights.constant", 1.0f);
        objShader.setFloat("pointLights.linear", 0.09f);
        objShader.setFloat("pointLights.quadratic", 0.032f);
